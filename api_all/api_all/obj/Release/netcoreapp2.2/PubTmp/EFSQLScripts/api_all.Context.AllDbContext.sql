...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20191024235217_newbd')
BEGIN
...
BEGIN
    CREATE TABLE [CarrinhoCompraItens] (
        ...
        [CarrinhoCompraId] nvarchar(100) NULL,
...
BEGIN
    ...
    VALUES (N'20191024235217_newbd', N'2.2.6-servicing-10079');
END;
